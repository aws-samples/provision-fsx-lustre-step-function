...
@mock_lambda
def mock_fsx_provision(lambda_name):
    ...
    assert json_resp['fsxFilesystemLifecycle'] == "CREATING"

@mock_lambda
def test_invoke_lambda():
    provisioned_lambda = mock_fsx_provision("fsx_provision")
...
def lambda_handler(event, context):
    return {
        "fsxFilesystemId": "fs-01146a2e26cd6b40c",
        "fsxFilesystemDnsName": "fs-01146a2e26cd6b40c.fsx.us-east-1.amazonaws.com",
        "fsxFilesystemMountName": "ivkx7bev",
        "fsxFilesystemLifecycle": "CREATING",
    }
"""
